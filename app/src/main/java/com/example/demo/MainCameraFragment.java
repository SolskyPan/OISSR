...
public class MainCameraFragment extends Fragment
    ...
    private List<OISResult> gyroList, acceleList, magneticList;
    long startTime;
     ...
     */
    private AutoFitMain mTextureView;
...
//                            sleep(1000);
    ...
    private final CameraCaptureSession.CaptureCallback mCaptureCallback
        ...
        public void onCaptureStarted(CameraCaptureSession session, CaptureRequest request,
            ...
            long currentDateTime = elapsedRealtimeNanos();

            mIndex++;

            File jpegFile = new File(folderName + "JPEG_" + (mIndex) + "_" + currentDateTime + ".jpg");

            File rawFile = new File(folderName + "RAW_" + (mIndex) + "_" + currentDateTime + ".dng");
...
//            if (requestId == startRequestID + mPictureNumber - 1) {
//                savePictures();
//            }
        }
...
//        for (int i = startRequestID; i < startRequestID + mPictureNumber; i++) {
//            ImageSaver.ImageSaverBuilder jpegBuilder = mJpegResultQueue.get(i);
//            ImageSaver.ImageSaverBuilder rawBuilder = mRawResultQueue.get(i);
//            handleCompletionLocked(i, jpegBuilder, mJpegResultQueue);
//            handleCompletionLocked(i, rawBuilder, mRawResultQueue);
//        }
//    }
    ...
    public static MainCameraFragment newInstance() {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        view.findViewById(R.id.picturemain).setOnClickListener(this);
        view.findViewById(R.id.recordmain).setOnClickListener(this);
        mTextureView = (AutoFitMain) view.findViewById(R.id.texturemain);
        mEditText = (EditText) view.findViewById(R.id.editTextMain);
        sensorManager = (SensorManager) getActivity().getSystemService(Context.SENSOR_SERVICE);
        button = (Button) view.findViewById(R.id.recordmain);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picturemain: {
                ...
                if (!s.equals("")) {
                    mPictureNumber = Integer.parseInt(mEditText.getText().toString());
                } else {
                    mPictureNumber = 5;
                }
                takePicture();
            ...
            case R.id.recordmain: {
                isRecording = !isRecording;
                if (isRecording) {
                    gyroList = new ArrayList<>();
                    acceleList = new ArrayList<>();
        ...
        try {
            ...
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size largestRaw = Collections.max(
                        ...
                        new CompareSizesByArea());
                Log.d("size", Arrays.toString(map.getOutputSizes(ImageFormat.JPEG)));
                Log.d("raw", Arrays.toString(map.getOutputSizes(ImageFormat.RAW_SENSOR)));
//                Log.d("sensor", characteristics.get(CameraCharacteristics.SENSOR_INFO_PRE_CORRECTION_ACTIVE_ARRAY_SIZE).toString());
                    ...
                    if (mJpegImageReader == null || mJpegImageReader.getAndRetain() == null) {
                        mJpegImageReader = new RefCountedAutoCloseable<>(
                                ImageReader.newInstance(1920,
                                        1080, ImageFormat.JPEG, /*maxImages*/15));
                    }
                    ...
                    if (mRawImageReader == null || mRawImageReader.getAndRetain() == null) {
                        mRawImageReader = new RefCountedAutoCloseable<>(
                                ImageReader.newInstance(largestRaw.getWidth(),
                                        largestRaw.getHeight(), ImageFormat.RAW_SENSOR, /*maxImages*/ 15));
                    }
    ...
    private static class ImageSaver implements Runnable {
        ...
        public void run() {
            ...
            Log.i(TAG, "Scanned " + mCaptureResult.getRequest().getTag() + ":");
            switch (format) {
    ...
    private void handleCompletionLocked(int requestId, ImageSaver.ImageSaverBuilder builder,
        ...
        Log.d(TAG, (saver != null) + " " + requestId + " " + builder.getSaveLocation());
        if (saver != null) {
