...
public class Camera2RawFragment extends Fragment
     ...
     */
    private AutoFitTextureViewRaw mTextureView;
...
//                        if (oisSamplesExport != null && oisSamplesExport.size() > 0) {
//                            // saveOisData();
//                        }
                        break;
                    }
...
//            File rawFile = new File(getActivity().getExternalFilesDir(Environment.DIRECTORY_PICTURES),
//                    (mIndex + 1) + "_" + currentDateTime + ".dng");
            Log.d("Capture: ", "started");
            mIndex++;
            File jpegFile = new File(getActivity().getExternalFilesDir(Environment.DIRECTORY_PICTURES),
                    (mIndex + 1) + "_" + currentDateTime + ".jpg");
...
//                mRawResultQueue.remove(requestId);
    ...
    public static com.example.demo.Camera2RawFragment newInstance() {
        return new com.example.demo.Camera2RawFragment();
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mCameraSwitch = view.findViewById(R.id.changeCamera);
        mCameraSwitch.setOnClickListener(this);

        mTextureView = (AutoFitTextureViewRaw) view.findViewById(R.id.textureraw);
        mEditText = (EditText) view.findViewById(R.id.editTextNumber);
...
//            textViewX.setText(String.format("X: %s", sensorEvent.values[0]));
//            textViewY.setText(String.format("Y: %s", sensorEvent.values[1]));
//            textViewZ.setText(String.format("Z: %s", sensorEvent.values[2]));
//            textViewTime.setText(String.format("Time: %s", sensorEvent.timestamp));
//        }
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.changeCamera: {
                ...
                openCamera();
                if (isMainCamera) {
                    mCameraSwitch.setText(R.string.main_camera);
                } else {
                    mCameraSwitch.setText(R.string.sub_camera);
                }
//                mPictureNumber = 1;
//                takePicture();
//                isMainCamera = !isMainCamera;
