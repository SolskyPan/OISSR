...
public class DemoVideoFragment extends Fragment
     ...
     */
    private AutoFitDemo mTextureView;
...
//                FileUtil.saveBitmap(bitmap, jpgPath);
    ...
    public static DemoVideoFragment newInstance() {
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mTextureView = (AutoFitDemo) view.findViewById(R.id.texture_demo);
        mButtonVideo = (Button) view.findViewById(R.id.video_demo);
        mButtonVideo.setOnClickListener(this);

        mButtonMusic = (Button) view.findViewById(R.id.music_demo);
        mButtonMusic.setOnClickListener(this);

        mOISSwitch = view.findViewById(R.id.ois_demo);
