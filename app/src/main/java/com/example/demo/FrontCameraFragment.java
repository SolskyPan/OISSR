...
public class FrontCameraFragment extends Fragment
    ...
    private static final String TAG = "FrontCameraFragment";
    ...
    private void openCamera(int width, int height) {
        ...
        try {
            ...
            for (String s : manager.getCameraIdList()) {
                ...
                Log.d(TAG, String.valueOf(characteristics.get(CameraCharacteristics.SENSOR_ORIENTATION)));
            }
            ...
            Log.d("Char OIS_DATA_MODES: ", Arrays.toString(characteristics.get(CameraCharacteristics.STATISTICS_INFO_AVAILABLE_OIS_DATA_MODES)));
            Log.d("Char ROTATION:  ", Arrays.toString(characteristics.get(CameraCharacteristics.LENS_POSE_ROTATION)));
            Log.d("Char TRANSLATION:  ", Arrays.toString(characteristics.get(CameraCharacteristics.LENS_POSE_TRANSLATION)));
                    ...
                    try {
                        ...
                        mPreviewSession.setRepeatingRequest(captureRequest, new CameraCaptureSession.CaptureCallback() {
                            ...
                            public void onCaptureCompleted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, @NonNull TotalCaptureResult result) {
                                ...
                                // Log.d("Camera: TRANSLATION", Arrays.toString(result.get(CaptureResult.LENS_POSE_TRANSLATION)));
...
//                                }
    ...
    private void stopRecordingVideo() {
        ...
        buffer.append("FrameIndex,InternalIndex,Timestamp,ShiftX,ShiftY\r\n");
