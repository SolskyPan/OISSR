...
public class DepthFragment extends Fragment
    ...
    private List<OISResult> acceleList;
     ...
     */
    private AutoFitDepth mTextureView;
...
//                FileUtil.saveBitmap(bitmap, jpgPath);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mTextureView = (AutoFitDepth) view.findViewById(R.id.texture_depth);
        mButtonVideo = (Button) view.findViewById(R.id.video_depth);
        mButtonVideo.setOnClickListener(this);

        mButtonMusic = (Button) view.findViewById(R.id.music_depth);
        mButtonMusic.setOnClickListener(this);

        mOISSwitch = view.findViewById(R.id.ois_depth);
        mOISSwitch.setOnClickListener(this);

        sensorManager = (SensorManager) getActivity().getSystemService(Context.SENSOR_SERVICE);
//        lineChartX = view.findViewById(R.id.lineChartX_demo);
//        lineChartY = view.findViewById(R.id.lineChartY_demo);
//        lineChartZ = view.findViewById(R.id.lineChartZ_demo);
...
//            }
        ...
        if(sensorEvent.sensor.getType() == Sensor.TYPE_LINEAR_ACCELERATION && mIsRecordingVideo) {
            OISResult oisResult = new OISResult();
            oisResult.x = sensorEvent.values[0];
            oisResult.y = sensorEvent.values[1];
            oisResult.z = sensorEvent.values[2];
        ...
        switch (view.getId()) {
            case R.id.video_depth: {
                if (mIsRecordingVideo) {
                    ...
                    musicAsyncTask.execute(mPlayer);
                }
                break;
            }
            case R.id.music_depth: {
                if (!musicFlag) {
                    mPlayer = new MediaPlayer();
                    try {
                        File file = getActivity().getExternalFilesDir(null);
...
//        Log.d(TAG, "setUpMediaRecorder: " + profile.videoFrameRate + " " + profile.videoCodec);
        ...
        mMediaRecorder.setOutputFile(mNextVideoAbsolutePath + "video.mp4");
...
//                                }
                            ...
                            public void onCaptureStarted(@NonNull CameraCaptureSession session, @NonNull CaptureRequest request, long timestamp, long frameNumber) {
                                ...
                                if (frame[0] == 0) {
                                    firstFrameTime = elapsedRealtimeNanos();
                                    frame[0]++;
                                }
                            }
                        }, mBackgroundHandler);
...
//                    .append(",").append(oisResult.oisSample.getYshift()).append("\r\n");
        ...
        try {
            ...
            String filename = mNextVideoAbsolutePath + "GYROSCOPE.txt";
        ...
        try {
            ...
            String filename = mNextVideoAbsolutePath + "ACCELERATION.txt";
        ...
        try {
            ...
            String filename =  mNextVideoAbsolutePath + "FirstFrameTime.txt";
//            String filename = mNextVideoAbsolutePath.substring(0, mNextVideoAbsolutePath.length() - 3) + "_GYROSCOPE.txt";
    ...
    private class MusicAsyncTask extends AsyncTask<MediaPlayer, Object, Long> {
        private MediaPlayer asnycPlayer;

        @Override
        protected Long doInBackground(MediaPlayer... players) {
            asnycPlayer = players[0];
            sleep(1000 * 2);
            asnycPlayer.start();
            for(int i = 0; i < 20; i++) {
                sleep(1000);
        ...
        protected void onPostExecute(Long aLong) {
            ...
            asnycPlayer.stop();
            Toast.makeText(getActivity(), "Music stop!", Toast.LENGTH_LONG).show();
        }
